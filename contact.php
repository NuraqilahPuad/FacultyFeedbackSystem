...
?>
       ...
       <div class="row">
            <div class="col-md-8">
                <h3><font color="">Contact us </font></h3>
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    UUMIT<br>UUM Information Technology (UUMIT), Universiti Utara Malaysia, Sintok, 06010, Kedah<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: (123) 123456</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="mailto:name@example.com">admin@admin.com</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">H</abbr>: Monday - Thursday: 9:00 AM to 9:00 PM</p>
